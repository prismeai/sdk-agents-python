...
class TestFiles:
    def test_path(self):
        ...
        assert f._path("files") == f"/workspaces/{WS}/webhooks/files"
    ...
    def test_upload_with_bytes(self):
        ...
        assert args[0] == f"/workspaces/{WS}/webhooks/files"
    ...
    def test_get(self):
        ...
        f = Files(client, WS)
        result = f.get("file-1")
        client.get.assert_called_once_with(f"/workspaces/{WS}/webhooks/files/file-1")

    def test_delete(self):
        client = _mock_client()
        f = Files(client, WS)
        f.delete("file-1")
        client.delete.assert_called_once_with(f"/workspaces/{WS}/webhooks/files/file-1")
    ...
    def test_download(self):
        ...
        client.request.assert_called_once_with(
            "GET",
            f"/workspaces/{WS}/webhooks/files/file-1/download",
            raw=True,
        )
...
class TestVectorStores:
    ...
    def test_path(self):
        ...
        assert vs._path("vector-stores") == f"/workspaces/{WS}/webhooks/vector-stores"
    ...
    def test_create(self):
        ...
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores",
    ...
    def test_get(self):
        ...
        vs = VectorStores(client, WS)
        result = vs.get("vs-1")
        client.get.assert_called_once_with(f"/workspaces/{WS}/webhooks/vector-stores/vs-1")
    ...
    def test_update(self):
        ...
        client.patch.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1",
            json={"name": "updated"},
        )
    ...
    def test_delete(self):
        ...
        vs = VectorStores(client, WS)
        vs.delete("vs-1")
        client.delete.assert_called_once_with(f"/workspaces/{WS}/webhooks/vector-stores/vs-1")
    ...
    def test_search(self):
        ...
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1/search",
    ...
    def test_reindex(self):
        ...
        vs = VectorStores(client, WS)
        vs.reindex("vs-1")
        client.post.assert_called_once_with(f"/workspaces/{WS}/webhooks/vector-stores/vs-1/reindex")

    def test_crawl_status(self):
        client = _mock_client()
        vs = VectorStores(client, WS)
        result = vs.crawl_status("vs-1")
        client.get.assert_called_once_with(f"/workspaces/{WS}/webhooks/vector-stores/vs-1/crawl-status")

    def test_recrawl(self):
        client = _mock_client()
        vs = VectorStores(client, WS)
        vs.recrawl("vs-1")
        client.post.assert_called_once_with(f"/workspaces/{WS}/webhooks/vector-stores/vs-1/recrawl")
...
class TestVSFiles:
    def test_path(self):
        ...
        assert vsf._path("vector-stores", "vs-1", "files") == f"/workspaces/{WS}/webhooks/vector-stores/vs-1/files"
    ...
    def test_add(self):
        ...
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1/files",
    ...
    def test_delete(self):
        ...
        client.delete.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1/files/file-1"
        )
    ...
    def test_chunks(self):
        ...
        client.get.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1/files/file-1/chunks"
        )
    ...
    def test_reindex(self):
        ...
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1/files/file-1/reindex"
        )
...
class TestVSAccess:
    ...
    def test_grant(self):
        ...
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1/access",
    ...
    def test_update(self):
        client = _mock_client()
        vsa = VSAccess(client, WS)
        result = vsa.update("vs-1", "access-1", role="editor")
        client.patch.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/vector-stores/vs-1/access/access-1",
            json={"role": "editor"},
        )
...
class TestSkills:
    def test_path(self):
        ...
        assert s._path("skills") == f"/workspaces/{WS}/webhooks/skills"
    ...
    def test_create(self):
        ...
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/skills",
    ...
    def test_get(self):
        ...
        client.get.assert_called_once_with(f"/workspaces/{WS}/webhooks/skills/skill-1")
    ...
    def test_update(self):
        ...
        client.patch.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/skills/skill-1",
    ...
    def test_delete(self):
        ...
        s = Skills(client, WS)
        s.delete("skill-1")
        client.delete.assert_called_once_with(f"/workspaces/{WS}/webhooks/skills/skill-1")
...
class TestStats:
    def test_path(self):
        ...
        assert s._path("stats") == f"/workspaces/{WS}/webhooks/stats"
    ...
    def test_get_no_params(self):
        ...
        result = s.get()
        client.get.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/stats",
            params={},
        )
