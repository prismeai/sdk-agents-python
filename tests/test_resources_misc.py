...
class TestArtifacts:
    def test_path(self):
        ...
        assert a._path("artifacts") == f"/workspaces/{WS}/webhooks/artifacts"
    ...
    def test_get(self):
        ...
        a = Artifacts(client, WS)
        result = a.get("art-1")
        client.get.assert_called_once_with(f"/workspaces/{WS}/webhooks/artifacts/art-1")
    ...
    def test_update(self):
        ...
        client.patch.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/artifacts/art-1",
    ...
    def test_delete(self):
        ...
        a = Artifacts(client, WS)
        a.delete("art-1")
        client.delete.assert_called_once_with(f"/workspaces/{WS}/webhooks/artifacts/art-1")

    def test_share(self):
        client = _mock_client()
        a = Artifacts(client, WS)
        a.share("art-1", public=True)
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/artifacts/art-1/share",
            json={"public": True},
        )
...
class TestShares:
    def test_path(self):
        ...
        assert s._path("shares") == f"/workspaces/{WS}/webhooks/shares"
    ...
    def test_get(self):
        ...
        client.get.assert_called_once_with(f"/workspaces/{WS}/webhooks/shares/share-1")
...
class TestRatings:
    def test_path(self):
        ...
        assert r._path("ratings") == f"/workspaces/{WS}/webhooks/ratings"

    def test_create(self):
        client = _mock_client()
        r = Ratings(client, WS)
        result = r.create(score=5, comment="Excellent", messageId="msg-1")
        client.post.assert_called_once_with(
            f"/workspaces/{WS}/webhooks/ratings",
...
class TestActivity:
    def test_path(self):
        ...
        assert a._path("activity") == f"/workspaces/{WS}/webhooks/activity"
...
class TestProfiles:
    def test_path(self):
        ...
        assert p._path("profiles") == f"/workspaces/{WS}/webhooks/profiles"
...
class TestOrgs:
    def test_path(self):
        ...
        assert o._path("orgs", "agents") == f"/workspaces/{WS}/webhooks/orgs/agents"
    ...
    def test_list_agents_with_params(self):
        client = _mock_client()
        o = Orgs(client, WS)
        page = o.list_agents(page=2, limit=5)
        assert page._page_size == 5
        assert page._start_page == 2
