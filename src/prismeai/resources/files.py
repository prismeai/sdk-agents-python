...
class Files:
    ...
    def download(self, file_id: str) -> Any:
        return self._client.request("GET", self._path("files", file_id, "download"), raw=True)
...
class AsyncFiles:
    ...
    async def download(self, file_id: str) -> Any:
        return await self._client.request("GET", self._path("files", file_id, "download"), raw=True)
