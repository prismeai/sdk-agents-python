...
class VectorStores:
    ...
    def list(self, *, page: Optional[int] = None, limit: Optional[int] = None) -> SyncCursorPage[Any]:
        return SyncCursorPage(self._client, "GET", self._path("vector-stores"), page_size=limit or 20, start_page=page or 1)
    def create(self, **kwargs: Any) -> Any:
        return self._client.post(self._path("vector-stores"), json=kwargs)
    def get(self, vector_store_id: str) -> Any:
        return self._client.get(self._path("vector-stores", vector_store_id))
    def update(self, vector_store_id: str, **kwargs: Any) -> Any:
        return self._client.patch(self._path("vector-stores", vector_store_id), json=kwargs)
    def delete(self, vector_store_id: str) -> None:
        self._client.delete(self._path("vector-stores", vector_store_id))
    def search(self, vector_store_id: str, **kwargs: Any) -> Any:
        return self._client.post(self._path("vector-stores", vector_store_id, "search"), json=kwargs)
    def reindex(self, vector_store_id: str) -> None:
        self._client.post(self._path("vector-stores", vector_store_id, "reindex"))
    def crawl_status(self, vector_store_id: str) -> Any:
        return self._client.get(self._path("vector-stores", vector_store_id, "crawl-status"))
    def recrawl(self, vector_store_id: str) -> None:
        self._client.post(self._path("vector-stores", vector_store_id, "recrawl"))
...
class AsyncVectorStores:
    ...
    def list(self, *, page: Optional[int] = None, limit: Optional[int] = None) -> AsyncCursorPage[Any]:
        return AsyncCursorPage(self._client, "GET", self._path("vector-stores"), page_size=limit or 20, start_page=page or 1)
    async def create(self, **kwargs: Any) -> Any:
        return await self._client.post(self._path("vector-stores"), json=kwargs)
    async def get(self, vector_store_id: str) -> Any:
        return await self._client.get(self._path("vector-stores", vector_store_id))
    async def update(self, vector_store_id: str, **kwargs: Any) -> Any:
        return await self._client.patch(self._path("vector-stores", vector_store_id), json=kwargs)
    async def delete(self, vector_store_id: str) -> None:
        await self._client.delete(self._path("vector-stores", vector_store_id))
    async def search(self, vector_store_id: str, **kwargs: Any) -> Any:
        return await self._client.post(self._path("vector-stores", vector_store_id, "search"), json=kwargs)
    async def reindex(self, vector_store_id: str) -> None:
        await self._client.post(self._path("vector-stores", vector_store_id, "reindex"))
    async def crawl_status(self, vector_store_id: str) -> Any:
        return await self._client.get(self._path("vector-stores", vector_store_id, "crawl-status"))
    async def recrawl(self, vector_store_id: str) -> None:
        await self._client.post(self._path("vector-stores", vector_store_id, "recrawl"))
